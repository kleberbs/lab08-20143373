	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		User user = us.getCurrentUser();
		 if(user == null){		
			 ...
			 if(us.isUserAdmin() || accesResource(user.getEmail(),"/editPhoto")){
		...
		if( req.getParameter("photo")!=null ){
			...
			try{
				...
				RequestDispatcher rd = getServletContext().getRequestDispatcher("/WEB-INF/Photo/edit.jsp");
				rd.forward(req, resp);
			}catch(Exception e){
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if( req.getParameter("photo")!=null ){
			...
			try{
				...
				foto.setName(req.getParameter("name"));
				foto.setDescription(req.getParameter("description"));
				req.setAttribute("foto", foto);
